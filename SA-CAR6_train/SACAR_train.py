...
c3 = Convolution2D(32, (5, 5), padding="same", kernel_initializer="he_normal")(m)
c3 = LeakyReLU(alpha=0.3)(c3)
c4 = Convolution2D(32, (5, 5), padding="same", kernel_initializer="he_normal")(c3)
c4 = LeakyReLU(alpha=0.3)(c4)
c5 = Convolution2D(32, (5, 5), padding="same", kernel_initializer="he_normal")(c4)
c5 = LeakyReLU(alpha=0.3)(c5)
c6 = Convolution2D(32, (5, 5), padding="same", kernel_initializer="he_normal")(c5)
c6 = LeakyReLU(alpha=0.3)(c6)
c7 = Convolution2D(1, (5, 5), padding="same", kernel_initializer="he_normal")(c6)
...
open('SACAR_model.json','w').write(json_string)  
model.save_weights('SACAR_model_weights.h5')
model.save('SACAR_model.h5')
