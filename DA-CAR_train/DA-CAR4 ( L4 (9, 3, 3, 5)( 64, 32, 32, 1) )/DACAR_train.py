...
c1 = Convolution2D(64, (9, 9), padding="same", kernel_initializer="he_normal")(x)
c1 = LeakyReLU(alpha=0.3)(c1)
c2 = Convolution2D(32, (3, 3), padding="same", kernel_initializer="he_normal")(c1)
c2 = LeakyReLU(alpha=0.3)(c2)
c3 = Convolution2D(32, (3, 3), padding="same", kernel_initializer="he_normal")(c2)
c3 = LeakyReLU(alpha=0.3)(c3)
c4 = Convolution2D(1, (5, 5), padding="same", kernel_initializer="he_normal")(c3)
